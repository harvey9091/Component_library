...
<body>
  ...
  <script>
    ...
    function renderComponent() {
      try {
        ...
        // Simple rendering without React if possible
        rootElement.innerHTML = '<div class="p-4 text-center"><h2 class="text-xl font-bold mb-2">${folder} Demo</h2><p class="text-gray-600">Component loaded but static rendering only.</p></div>';
      } catch (error) {
  ...
  <!-- Load the bundled component (includes all dependencies) -->
